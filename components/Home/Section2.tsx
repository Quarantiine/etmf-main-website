				...
				<div className="flex flex-row w-full h-full relative justify-start items-center gap-5">
					<>
						<div className="hidden md:block relative w-[700px] h-fit">
							...
							<div
								ref={shadowRef}
								className="shadow-[0px_0px_200px_200px_rgba(255,215,0,1)] opacity-0 bg-yellow w-30 h-30 rounded-full absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 z-[-1]"
							></div>
						</div>
					</>
