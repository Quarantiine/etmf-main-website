...
export default function WidgetComponent(): React.ReactElement {
	return (
		<>
			...
			<div className="fixed bottom-5 right-0 z-50 text-white">
				<Link
					href={
						"https://docs.google.com/forms/d/e/1FAIpQLSfgKKg44BaBRps6JjVtx_6jy68q1pxT1VJbnBWchvoX556Lqw/viewform?usp=sf_Link"
					}
					target="_blank"
					className="w-fit h-32 p-5 bg-green-3 rounded-l-xl shadow-[0px_0px_10px_0px_rgba(0,0,0,0.4)] relative no-style-btn block"
				>
