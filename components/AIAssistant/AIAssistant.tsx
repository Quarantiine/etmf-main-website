...
export default function AIAssistant(): React.ReactElement {
  ...
  return (
    <>
      ...
      {openAIAssistant && (
        <>
          <div className="ai-assistant-modal hidden sm:flex fixed bottom-16 right-16 w-64 h-80 bg-white rounded-2xl shadow-xl flex-col justify-center items-center p-5 z-50">
            <p>AI Assistant</p>
          </div>
